...
const Profile = () => {
    ...
    const filterItems = (items) => {
        ...
        return items.filter(item => {
            ...
            // FIX: Add a type check to ensure 'service' is a string before calling .toLowerCase()
            const servicesMatch = item.selectedServices?.some(service => 
                            ...
                            {activeTab === 'appointments' && (
                                <>
                                    ...
                                    {filteredAdminAppointments.length === 0 ? (
                                        <p className="Profile-Appointments-message">No appointments found matching your search.</p>
                                    ) : (
                            ...
                            {activeTab === 'quotes' && (
                                <>
                                    ...
                                    {filteredQuoteRequests.length === 0 ? (
                                        <p className="Profile-Quote-message">No quote requests found matching your search.</p>
                                    ) : (
                            ...
                            {activeTab === 'contacts' && (
                                <>
                                    ...
                                    {filteredContactSubmissions.length === 0 ? (
                                        <p className="Profile-Contact-message">No contact submissions found matching your search.</p>
                                    ) : (

    ...
    <section className="objection-blockers-wrapper">
      ...
      <div className="main-content-row">
        <div className="objection-block-item">
          <img className="obj-img" src={ecoFriendly} alt="Eco Friendly Products" />{' '}
          {/* More descriptive alt text */}
          <div className="img-text">
            <h3>Eco-Friendly</h3> {/* Changed to h3 for semantic heading within item */}
            <p>We only use eco-friendly products and materials for a healthier environment.</p>{' '}
            {/* Clarified text */}
          </div>
        </div>

        <div className="objection-block-item">
          <img className="obj-img" src={Savings} alt="Cost Savings and Discounts" />{' '}
          {/* More descriptive alt text */}
          <div className="img-text">
            <h3>Affordable Pricing</h3> {/* Changed to h3 and more direct */}
            <p>We offer competitive pricing and various discounts to fit your budget.</p>{' '}
            {/* Clarified text */}
          </div>
        </div>
